...
function HospitalCard({ id, image, name, address, fees }) {
  ...
  return (
    ...
    >
      ...
      <Divider />
      <Text>
        <span style={{ fontWeight: "bold" }}>Hospital name :</span> {name}
      </Text>
      <Text>
        <span style={{ fontWeight: "bold" }}>Address :</span> {address}
      </Text>
      <Text>
        <span style={{ fontWeight: "bold" }}>Consultation fee :</span> {fees}
      </Text>
      <Divider />
      ...
      <Modal isOpen={isOpen} onClose={onClose} size="sm" isCentered>
        ...
        <ModalContent bg="#63E26C">
          <ModalHeader style={{ margin: "auto", marginTop: "1rem" }}>
            <span style={{ fontWeight: "bold" }}>Hospital name : {name}</span>
          </ModalHeader>
          <ModalCloseButton />
          <ModalBody>
            <VStack align="left" spacing={4}>
              ...
              <Text>
                <span style={{ fontWeight: "bold" }}>Consultation fee :</span>{" "}
                {fees}
              </Text>
            </VStack>
          </ModalBody>
